...
class Stream:
    ...
    @property
    def input_url(self):
        return self.json().get('input_url')

    @property
    def output_url(self):
        return self.json().get('output_url')

    @property
    def stream_contract_id(self):
        return self.json().get('stream_contract_id')

    @property
    def stream_contract_address(self):
        return self.json().get('stream_contract_address')
    ...
    def input_status(self):
        return self.json().get('input_status')
    ...
    @property
    def ready_at(self):
        return self.json().get('ready_at')

    @property
    def completed_at(self):
        return self.json().get('completed_at')

    @property
    def rtmp_url(self):
        return self.json().get('rtmp_url')
